...
* [`src/clj/scify_clj/`](src/clj/scify_clj/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/scify_clj/`](src/cljs/scify_clj/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/scify_clj/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/scify_clj/`](test/cljs/scify_clj/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `scify-clj` project root directory
...
in the [`src/clj/scify_clj/`](src/clj/scify_clj/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/scify_clj/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns scify-clj.example
  (:require [scify-clj.config :as config])
